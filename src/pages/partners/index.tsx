        ...
        <PartnerContent
          ...
          <div className='flex w-full flex-row items-center justify-center gap-[20px]'>
            <div className='lg:hidden'>
              ...
              <select
                id='tabs'
                className='block w-full min-w-[330px] rounded-lg border border-gray-300 bg-gray-50 p-2.5 px-2 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 md:min-w-[470px]'
                onChange={e => {
          ...
          <div className='mt-8 grid grid-cols-1 gap-[5px] px-2 sm:grid-cols-2 lg:grid-cols-4'>
            <>
