...
module.exports = {
  ...
  theme: {
    backgroundImage: {
      ...
      'kacpta-header-bg': "url('/images/new/interview/clientbgimage/KacptaBgImage.svg')",
      'pyeongtaek-header-bg': "url('/images/new/interview/clientbgimage/PyeongtaekBgImage.svg')",
      'comwel-header-bg': "url('/images/new/interview/clientbgimage/ComwelBgImage.svg')",
      'gyeongnam-header-bg': "url('/images/new/interview/clientbgimage/GyeongnamBgImage.svg')",
      'yit-header-bg': "url('/images/new/interview/clientbgimage/YitBgImage.svg')",
      'kipo-header-bg': "url('/images/new/interview/clientbgimage/KipoBgImage.svg')",
      'cnuh-header-bg': "url('/images/new/interview/clientbgimage/CnuhBgImage.svg')",
      'gntel-header-bg': "url('/images/new/interview/clientbgimage/GntelBgImage.svg')",
      'spo-header-bg': "url('/images/new/interview/clientbgimage/SpoBgImage.svg')",
      'dtaq-header-bg': "url('/images/new/interview/clientbgimage/DtaqBgImage.svg')",
      'datastreams-header-bg': "url('/images/new/interview/clientbgimage/DatastreamsBgImage.svg')",
